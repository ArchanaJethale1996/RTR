package project.rtr.rendertotexture;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer,OnGestureListener, OnDoubleTapListener {
	...
	private int[] gFrameBuffer = new int[1];
	...
	private void Initialize()
	{
		...
		//frame buffer changes	
		GLES32.glGenFramebuffers(1, gFrameBuffer,0);
		GLES32.glBindFramebuffer(GLES32.GL_FRAMEBUFFER, gFrameBuffer[0]);
		//color
		...
		GLES32.glTexImage2D(GLES32.GL_TEXTURE_2D, 0, GLES32.GL_RGBA, 100, 100, 0, GLES32.GL_RGBA, GLES32.GL_UNSIGNED_BYTE, null);
		GLES32.glBindTexture(GLES32.GL_TEXTURE_2D, 0);

		//depth
		GLES32.glGenTextures(1, gDepthTexture,0);
		GLES32.glBindTexture(GLES32.GL_TEXTURE_2D, gDepthTexture[0]);
		GLES32.glTexStorage2D(GLES32.GL_TEXTURE_2D, 1, GLES32.GL_DEPTH_COMPONENT32F, 100, 100);
		GLES32.glBindTexture(GLES32.GL_TEXTURE_2D, 0);

		//Attach Attachments
		GLES32.glFramebufferTexture(GLES32.GL_FRAMEBUFFER, GLES32.GL_COLOR_ATTACHMENT0, gColorTexture[0], 0);
		GLES32.glFramebufferTexture(GLES32.GL_FRAMEBUFFER, GLES32.GL_DEPTH_ATTACHMENT, gDepthTexture[0], 0);
		...
		textureKundali[0]=LoadTexture(R.raw.kundali);
	...
	private void resize(int width,int height)
	{
		...
		if (gFrameBuffer[0]!=0)
		{
			...
			GLES32.glGenTextures(1, gDepthTexture,0);
			GLES32.glBindTexture(GLES32.GL_TEXTURE_2D, gDepthTexture[0]);
			GLES32.glTexStorage2D(GLES32.GL_TEXTURE_2D, 1, GLES32.GL_DEPTH_COMPONENT32F, width, height);
			GLES32.glBindTexture(GLES32.GL_TEXTURE_2D, 0);
	...
	private void display()
	{
		...
		float[] cc={0.0f, 1.0f, 0.0f, 1.0f};
	float[] cd = { 1.0f, 1.0f, 0.0f, 1.0f };
		GLES32.glClearBufferfv(GLES32.GL_COLOR, 0, cc,0);
	GLES32.glClearBufferfv(GLES32.GL_DEPTH, 0, cd,0);
