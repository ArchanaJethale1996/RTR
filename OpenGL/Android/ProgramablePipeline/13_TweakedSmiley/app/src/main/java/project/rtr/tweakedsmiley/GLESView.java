package project.rtr.tweakedsmiley;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer,OnGestureListener, OnDoubleTapListener {
	...
	private void display()
	{
		...
		float[] SmileyTexture=new float[8];
		if (numberOfTaps == 0)
		{
			SmileyTexture[0]=(0.5f);
			SmileyTexture[1]=(0.5f);
			SmileyTexture[2]=(0.5f);
			SmileyTexture[3]=(0.5f);
			SmileyTexture[4]=(0.5f);
			SmileyTexture[5]=(0.5f);
			SmileyTexture[6]=(0.5f);
			SmileyTexture[7]=(0.5f);
		}
		if (numberOfTaps == 1)
		{
			SmileyTexture[0]=(2.0f);
			SmileyTexture[1]=(2.0f);
			SmileyTexture[2]=(0.0f);
			SmileyTexture[3]=(2.0f);
			SmileyTexture[4]=(0.0f);
			SmileyTexture[5]=(0.0f);
			SmileyTexture[6]=(2.0f);
			SmileyTexture[7]=(0.0f);
		}
		if (numberOfTaps == 2)
		{
