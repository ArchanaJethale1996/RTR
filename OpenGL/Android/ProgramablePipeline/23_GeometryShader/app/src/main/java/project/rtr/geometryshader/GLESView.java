package project.rtr.geometryshader;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer,OnGestureListener, OnDoubleTapListener {
	...
	private int gGeomeryShaderObject;
	...
	private void Initialize()
	{
		...
		//VertexShader Object
		gGeomeryShaderObject = GLES32.glCreateShader(GLES32.GL_GEOMETRY_SHADER);
		...
		"in vec3 out_vColor[3];" +
		"out vec3 out_vgmColor;" +
		"uniform mat4 u_mvp_matrix;" +
		"void main(void)" +
		"{" +
		...
		"out_vgmColor=out_vColor[vertex];" +
		"EmitVertex(); " +
		...
		//Specify the above source code to the shader object
		GLES32.glShaderSource(gGeomeryShaderObject, geometryShaderSourceCode);

		//compile the vertex shader source code
		GLES32.glCompileShader(gGeomeryShaderObject);
		...
		GLES32.glGetShaderiv(gGeomeryShaderObject, GLES32.GL_COMPILE_STATUS, iShaderCompileStatus,0);
		if (iShaderCompileStatus[0] == GLES32.GL_FALSE)
		{
			GLES32.glGetShaderiv(gGeomeryShaderObject, GLES32.GL_INFO_LOG_LENGTH, iInfoLength,0);
			if (iInfoLength[0] > 0)
			{
					szInfoLog=GLES32.glGetShaderInfoLog(gGeomeryShaderObject);
					System.out.println("RTR : "+szInfoLog);
					unInitialize();
					System.exit(0);
			}
		...
		final String fragmentShaderSourceCode =
			...
			"in vec3 out_vgmColor;" +
		"out vec4 FragColor;" +
		"void main(void)" +
		"{" +
		"FragColor=vec4(out_vgmColor,1.0);" +
		"}";
		...
		GLES32.glAttachShader(shaderProgramObject, gGeomeryShaderObject);
	...
	GLES32.glBindAttribLocation(shaderProgramObject, GLESMacros.AMC_ATTRIBUTE_COLOR, "vColor");
		...
		//Convert the array which can be sent to buffer Data
		ByteBuffer byteBuffer1=ByteBuffer.allocateDirect(triangleColor.length*4);
		//Arrange the buffer in native byte order
