...
var lightPositionZero=[100.0,100.0,100.0,1.0];
var lightAngleZero = 0.0;

var lightAmbientOne=[0.0,0.0,0.0];
var lightDiffusedOne=[0.0,1.0,0.0];
var lightSpecularOne=[0.0,1.0,0.0];
var lightPositionOne=[100.0,100.0,100.0,1.0];
var lightAngleOne = 0.0;

var lightAmbientTwo=[0.0,0.0,0.0];
var lightDiffusedTwo=[0.0,0.0,1.0];
var lightSpecularTwo=[0.0,0.0,1.0];
var lightPositionTwo=[100.0,100.0,100.0,1.0];
...
var LDUniformZeroPerVertex, LAUniformZeroPerVertex, LSUniformZeroPerVertex, LightPositionUniformZeroPerVertex, LDUniformOnePerVertex, LAUniformOnePerVertex, LSUniformOnePerVertex, LightPositionUniformOnePerVertex, LDUniformTwoPerVertex, LAUniformTwoPerVertex, LSUniformTwoPerVertex, LightPositionUniformTwoPerVertex;
var LKeyIsPressedUniform_PerVertex;
...
var LDUniformZeroPerFragment, LAUniformZeroPerFragment, LSUniformZeroPerFragment, LightPositionUniformZeroPerFragment, LDUniformOnePerFragment, LAUniformOnePerFragment, LSUniformOnePerFragment, LightPositionUniformOnePerFragment, LDUniformTwoPerFragment, LAUniformTwoPerFragment, LSUniformTwoPerFragment, LightPositionUniformTwoPerFragment;
var LKeyIsPressedUniform_PerFragment;
...
"in vec4 vPosition;" +
	...
	LDUniformZeroPerVertex = gl.getUniformLocation(shaderProgramObject_PerVertex, "u_LdZero");
	LAUniformZeroPerVertex = gl.getUniformLocation(shaderProgramObject_PerVertex, "u_LaZero");
	LSUniformZeroPerVertex = gl.getUniformLocation(shaderProgramObject_PerVertex, "u_LsZero");
	LightPositionUniformZeroPerVertex = gl.getUniformLocation(shaderProgramObject_PerVertex, "u_Light_PositionZero");
	...
	LDUniformZeroPerFragment = gl.getUniformLocation(shaderProgramObject_PerFragment, "u_LdZero");
	LAUniformZeroPerFragment = gl.getUniformLocation(shaderProgramObject_PerFragment, "u_LaZero");
	LSUniformZeroPerFragment = gl.getUniformLocation(shaderProgramObject_PerFragment, "u_LsZero");
	LightPositionUniformZeroPerFragment = gl.getUniformLocation(shaderProgramObject_PerFragment, "u_Light_PositionZero");
...
function draw()
{
    ...
    if (gPerFragment == true) {
        ...
        if (gLighting == 1) {
			...
			lightPositionZero[1] = Math.sin(rotateSphere) * 100.0;
			lightPositionZero[2] = Math.cos(rotateSphere) * 100.0 - 3.0;
			gl.uniform4fv(LightPositionUniformZeroPerFragment,lightPositionZero);

			lightPositionOne[0] = Math.sin(rotateSphere) * 100.0;
			lightPositionOne[1] = 0.0;
			lightPositionOne[2] = Math.cos(rotateSphere) * 100.0 - 3.0;
			gl.uniform4fv(LightPositionUniformOnePerFragment, lightPositionOne);

			lightPositionTwo[0] = Math.cos(rotateSphere) * 100.0;
			lightPositionTwo[1] = Math.sin(rotateSphere) * 100.0;
			lightPositionTwo[2] = -3.0;
			gl.uniform4fv(LightPositionUniformTwoPerFragment,lightPositionTwo);

			gl.uniform3fv(LAUniformZeroPerFragment, lightAmbientZero);
			gl.uniform3fv(LDUniformZeroPerFragment, lightDiffusedZero);
			gl.uniform3fv(LSUniformZeroPerFragment, lightSpecularZero);

			gl.uniform3fv(LAUniformOnePerFragment,lightAmbientOne);
			gl.uniform3fv(LDUniformOnePerFragment,lightDiffusedOne);
			gl.uniform3fv(LSUniformOnePerFragment,lightSpecularOne);

			gl.uniform3fv(LAUniformTwoPerFragment,lightAmbientTwo);
			gl.uniform3fv(LDUniformTwoPerFragment,lightDiffusedTwo);
			gl.uniform3fv(LSUniformTwoPerFragment,lightSpecularTwo);
    ...
    else
    {
        ...
        if (gLighting == 1) {
			...
			lightPositionZero[1] = Math.sin(rotateSphere) * 100.0;
			lightPositionZero[2] = Math.cos(rotateSphere) * 100.0 - 3.0;
			gl.uniform4fv(LightPositionUniformZeroPerVertex, lightPositionZero);

			lightPositionOne[0] = Math.sin(rotateSphere) * 100.0;
			lightPositionOne[1] = 0.0;
			lightPositionOne[2] = Math.cos(rotateSphere) * 100.0- 3.0;			
			gl.uniform4fv(LightPositionUniformOnePerVertex, lightPositionOne);

			lightPositionTwo[0] = Math.cos(rotateSphere) * 100.0;
			lightPositionTwo[1] =Math. sin(rotateSphere) * 100.0;
			lightPositionTwo[2] = -3.0;
			gl.uniform4fv(LightPositionUniformTwoPerVertex, lightPositionTwo);

			gl.uniform3fv(LAUniformZeroPerVertex, lightAmbientZero);
			gl.uniform3fv(LDUniformZeroPerVertex, lightDiffusedZero);
			gl.uniform3fv(LSUniformZeroPerVertex, lightSpecularZero);

			gl.uniform3fv(LAUniformOnePerVertex, lightAmbientOne);
			gl.uniform3fv(LDUniformOnePerVertex, lightDiffusedOne);
			gl.uniform3fv(LSUniformOnePerVertex, lightSpecularOne);

			gl.uniform3fv(LAUniformTwoPerVertex, lightAmbientTwo);
			gl.uniform3fv(LDUniformTwoPerVertex, lightDiffusedTwo);
			gl.uniform3fv(LSUniformTwoPerVertex, lightSpecularTwo);
	...
	rotateSphere = rotateSphere+0.10;
