...
BOOL LoadTextureWhite(void)
{
	...
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, CHECK_IMAGE_WIDTH, CHECK_IMAGE_HEIGHT, 0, GL_RGB, GL_UNSIGNED_BYTE, checkImage);
