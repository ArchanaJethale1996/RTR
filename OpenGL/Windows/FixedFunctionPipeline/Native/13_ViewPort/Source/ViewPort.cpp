...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_KEYDOWN:
		...
		case 0x60:
		case 0x30:
			iViewPortSelection = 0;		
			resize(gwidth, gheight);
			break;
		case 0x61:
		case 0x31:
			iViewPortSelection = 1;
			resize(gwidth, gheight);
			break;
		case 0x62:
		case 0x32:
			iViewPortSelection = 2;
			resize(gwidth, gheight);
			break;
		case 0x63:
		case 0x33:
			iViewPortSelection = 3;
			resize(gwidth, gheight);
			break;
		case 0x64:
		case 0x34:
			iViewPortSelection = 4;
			resize(gwidth, gheight);
			break;
		case 0x65:
		case 0x35:
			iViewPortSelection = 5;
			resize(gwidth, gheight);
			break;
		case 0x66:
		case 0x36:
			iViewPortSelection = 6;
			resize(gwidth, gheight);
			break;
		case 0x67:
		case 0x37:
			iViewPortSelection = 7;
			resize(gwidth, gheight);
			break;
		case 0x68:
		case 0x38:
			iViewPortSelection = 8;
			resize(gwidth, gheight);
			break;
		case 0x69:
		case 0x39:
			iViewPortSelection = 9;
			resize(gwidth, gheight);
			break;
		default:
			break;
