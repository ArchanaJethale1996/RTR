...
-(void)applicationDidFinishLaunching:(NSNotification *)aNotification
{
    ...
    NSString *logFileNameWithPath=[NSString stringWithFormat:@"%@/Log2.txt",parentDirPath];
...
-(void)reshape
{
    ...
    if(width<=height)
   {
        orthographicProjectionMatrix=vmath::ortho(-100.0f,100.0f,(-100.0f*(height/width)),(100.0*(height/width)),-100.0f,100.0f);
    } 
    else
    {
        orthographicProjectionMatrix=vmath::ortho((-100.0f*(width/height)),(100.0*(width/height)),-100.0f,100.0f,-100.0f,100.0f);
    } 
