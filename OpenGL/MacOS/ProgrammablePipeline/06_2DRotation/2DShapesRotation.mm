...
-(void)prepareOpenGL
{
    ...
    glGetShaderiv(vertexShaderObject, GL_COMPILE_STATUS, &iShaderComileStatus);
    ...
    glGetShaderiv(fragmentShaderObject, GL_COMPILE_STATUS, &iShaderComileStatus);
    if (iShaderComileStatus == GL_FALSE)
    {
...
-(void)drawView
{
    ...
    static  GLfloat rotateTriangle = 0.0f, rotateRectangle = 360.0f;
    [[self openGLContext]makeCurrentContext];
    CGLLockContext((CGLContextObj)[[self openGLContext]CGLContextObj]);
    ...
    rotationMatrix=vmath::rotate(rotateTriangle, 0.0f, 1.0f, 0.0f);
    ...
    rotationMatrix=vmath::rotate(rotateRectangle, 0.0f,1.0f,0.0f);
    modelViewMatrix = modelViewMatrix*rotationMatrix;
