...
HRESULT initialize(void)
{
	...
	bufferDesc_position_Rectangle.ByteWidth = sizeof(float)*ARRAYSIZE(vertices);
	...
	bufferDesc_color_Rectangle.ByteWidth = sizeof(float)*ARRAYSIZE(verticesColor);
...
void display(void)
{
	...
	//XMMATRIX rotationMatrix = XMMatrixRotationY(10.0f);
