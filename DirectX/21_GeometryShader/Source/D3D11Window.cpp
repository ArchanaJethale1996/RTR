...
//	{
//		fopen_s(&gpFile, gszLogFileName, "a+");
//		fprintf_s(gpFile, "D3DCompile() succeded For GeometryShader.\n");
//		fclose(gpFile);
//	}
//
//	hr = gpD3D11Device->CreateGeometryShader(pID3DBlob_GeometryShaderCode->GetBufferPointer(),
//		pID3DBlob_GeometryShaderCode->GetBufferSize(),
//		NULL,&gpID3D11GeometryShader);
//	if (FAILED(hr))
//	{
//		fopen_s(&gpFile, gszLogFileName, "a+");
//		fprintf_s(gpFile, "gpD3D11Device->CreateGeometryShader() Failed.\n");
//		fclose(gpFile);
//		return(hr);
//	}
//	else
//	{
//		fopen_s(&gpFile, gszLogFileName, "a+");
//		fprintf_s(gpFile, "gpD3D11Device->CreateGeometryShader() Succeded.\n");
//		fclose(gpFile);
//	}
//
...
//	bufferDesc_position_Triangle.ByteWidth = sizeof(float)*_ARRAYSIZE(vertices);
...
//	hr = gpD3D11Device->CreateBuffer(&bufferDesc_position_Triangle, NULL, &gpID3D11Buffer_VertexBuffer);
//	if (FAILED(hr))
//	{
//		fopen_s(&gpFile, gszLogFileName, "a+");
...
//	gpID3D11DeviceContext->Map(gpID3D11Buffer_VertexBuffer, NULL, D3D11_MAP_WRITE_DISCARD, 0, &mappedSubresource);
...
//
//
//	hr = gpD3D11Device->CreateInputLayout(&inputElementDesc,1, pID3DBlob_VertexShaderCode->GetBufferPointer(), pID3DBlob_VertexShaderCode->GetBufferSize(), &gpID3D11InputLayout);
//	if (FAILED(hr))
//	{
//		fopen_s(&gpFile, gszLogFileName, "a+");
...
//	hr = gpD3D11Device->CreateBuffer(&bufferDesc_ConstantBuffer, nullptr, &gpID3D11Buffer_ConstantBuffer);
//	if (FAILED(hr))
//	{
//		fopen_s(&gpFile, gszLogFileName, "a+");
...
//	gpD3D11Device->CreateTexture2D(&textureDesc, NULL, &pID3D11Texture2D_DepthBuffer);
//
//	//create 
...
//	hr = gpD3D11Device->CreateDepthStencilView(pID3D11Texture2D_DepthBuffer, &depthStencilViewDesc, &gpID3D11DepthStencilView);
//	if (FAILED(hr))
//	{
//		return(hr);
//	}
